    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-bright-lavender-200">{message}</p>

          <div className="mt-6 space-y-4">
            {status === "success" && (
              <div className="bg-green-950 border border-green-700 rounded-md p-4">
                <p className="text-green-200 text-sm">
                  Welcome to Visagify! You&apos;ll be redirected to your
                  dashboard shortly.
                </p>
              </div>
            )}
              ...
              <div className="space-y-4">
                <div className="bg-yellow-950 border border-yellow-700 rounded-md p-4">
                  <p className="text-yellow-200 text-sm">
                    Your confirmation link has expired. Please request a new
                    one.
                  </p>
                </div>
                <a
